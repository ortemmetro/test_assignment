...
|-------------|---------------------------|--------------------|--------------------|
| ![<img src="screenshots/home_page.png" width="200px"> ](screenshots/home_page.png ) | ![select_location](screenshots/map_page1.png =100x20) | ![bottom_sheet](screenshots/map_page2.png =100x20) | ![booked_rides](screenshots/booked_rides_page.png =100x20) |
